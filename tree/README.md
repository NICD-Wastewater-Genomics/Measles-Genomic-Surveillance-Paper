...
- `tree`: Additional scripts used for tree-based analyses 

All wastewater sequencing raw data is available via NCBI SRA, and consensus sequences are available via Pathoplexus. 