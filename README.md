...
- `src`: R and Python scripts needed for all bioinformatic and epidemiological analyses
- `demo`: minimal, self-contained demo of the mapping/trimming/Freyja pipeline on a few public SRA samples
